    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='DATETIME CREATED')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='DATETIME UPDATED')),
                ('countryboundaryCRS', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='coordinatesystem_countries', to='parcels.coordinatesystem', verbose_name='BOUNDARY COORDINATE SYSTEM')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='DATETIME CREATED')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='DATETIME UPDATED')),
                ('districtboundaryCRS', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='coordinatesystem_districts', to='parcels.coordinatesystem', verbose_name='BOUNDARY COORDINATE SYSTEM')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('townboundaryCRS', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='coordinatesystem_towns', to='parcels.coordinatesystem', verbose_name='BOUNDARY COORDINATE SYSTEM')),
            ],
            options={
                'verbose_name': 'TOWN',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('regionboundaryCRS', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='coordinatesystem_regions', to='parcels.coordinatesystem', verbose_name='BOUNDARY COORDINATE SYSTEM')),
            ],
            options={
                'verbose_name': 'REGION',
