    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(max_length=100, unique=True, verbose_name='UNIQUE CODE')),
                ('name', models.CharField(max_length=250, unique=True, verbose_name='NAME')),
                ('countryboundaryDEFAULT', models.TextField(blank=True, null=True, verbose_name='BOUNDARY POLYGON DATA[<<{WKT}FORMAT => POLYGON((east_lon1 north_lat1, east_lon2 north_lat2, ...east_lonN north_latN, east_lon1 north_lat1))>>)>>]')),
                ...
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='DATETIME CREATED')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='DATETIME UPDATED')),
                ('countryboundaryCRS', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='coordinatesystem_countries', to='parcels.coordinatesystem', verbose_name='BOUNDARY COORDINATE SYSTEM')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('districtboundaryDEFAULT', models.TextField(blank=True, null=True, verbose_name='BOUNDARY POLYGON DATA[<<{WKT}FORMAT => POLYGON((east_lon1 north_lat1, east_lon2 north_lat2, ...east_lonN north_latN, east_lon1 north_lat1))>>)>>]')),
                ...
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='DATETIME CREATED')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='DATETIME UPDATED')),
                ('districtboundaryCRS', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='coordinatesystem_districts', to='parcels.coordinatesystem', verbose_name='BOUNDARY COORDINATE SYSTEM')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(max_length=100, unique=True)),
                ('name', models.CharField(max_length=250, unique=True)),
                ('townboundaryDEFAULT', models.TextField(blank=True, null=True, verbose_name='BOUNDARY POLYGON DATA[<<{WKT}FORMAT => POLYGON((east_lon1 north_lat1, east_lon2 north_lat2, ...east_lonN north_latN, east_lon1 north_lat1))>>)>>]')),
                ...
                ('townboundaryCRS', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='coordinatesystem_towns', to='parcels.coordinatesystem', verbose_name='BOUNDARY COORDINATE SYSTEM')),
            ],
            options={
                'verbose_name': 'TOWN',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(max_length=100, unique=True, verbose_name='UNIQUE CODE')),
                ('name', models.CharField(max_length=250, unique=True, verbose_name='NAME')),
                ('regionboundaryDEFAULT', models.TextField(blank=True, null=True, verbose_name='BOUNDARY POLYGON DATA[<<{WKT}FORMAT => POLYGON((east_lon1 north_lat1, east_lon2 north_lat2, ...east_lonN north_latN, east_lon1 north_lat1))>>)>>]')),
                ...
                ('regionboundaryCRS', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='coordinatesystem_regions', to='parcels.coordinatesystem', verbose_name='BOUNDARY COORDINATE SYSTEM')),
            ],
            options={
                'verbose_name': 'REGION',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('code', models.CharField(max_length=100, unique=True)),
                ('parcelboundaryDEFAULT', models.TextField(verbose_name='BOUNDARY POLYGON DATA[<<{WKT}FORMAT => POLYGON((east_lon1 north_lat1, east_lon2 north_lat2, ...east_lonN north_latN, east_lon1 north_lat1))>>)>>]')),
                ('parcelreferenceDEFAULT', models.TextField(blank=True, null=True, verbose_name='REFERENCES MULTIPOINT DATA[<<{WKT}FORMAT => MULTIPOINT(east_lon1 north_lat1, east_lon2 north_lat2, ...east_lonN north_latN)>>]')),
                ...
                ('parcelboundarycenterWGS84', django.contrib.gis.db.models.fields.PointField(blank=True, editable=False, null=True, srid=4326, verbose_name='PARCEL BOUNDARY CENTER WGS84')),
